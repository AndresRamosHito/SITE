...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v--5sCwUtP.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-D5x7JZDN.js").then((n) => n.r),
    import("./start-Chse1mPG.js"),
...
var ROUTER_BASEPATH = "orquidea";
var SERVER_FN_BASE = "/orquidea/_serverFn/";
